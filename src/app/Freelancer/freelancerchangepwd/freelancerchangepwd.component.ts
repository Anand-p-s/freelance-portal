...
@Component({
  selector: 'app-freelancerchangepwd',
  templateUrl: './freelancerchangepwd.component.html',
  styleUrls: ['./freelancerchangepwd.component.scss'],
})
export class FreelancerchangepwdComponent {
